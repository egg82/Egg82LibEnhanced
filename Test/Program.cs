...
namespace Test {
	class Program {
		...
		static void Main(string[] args) {
			...
			graphicsWindow = new Egg82LibEnhanced.Display.Window(1280, 720, "Graphics Test", Styles.Titlebar | Styles.Close | Styles.Resize, false, 16);
			graphicsWindow.AddState(new GraphicsTestState());

			/*physicsWindow = new Egg82LibEnhanced.Display.Window(1280, 720, "Physics Test", Styles.Titlebar | Styles.Close, true, 16);
			physicsWindow.AddState(new PhysicsTestState());*/

			/*inputWindow = new Egg82LibEnhanced.Display.Window(1280, 720, "Input Test", Styles.Titlebar | Styles.Close, true, 16);
			inputWindow.AddState(new InputTestState());*/

			/*clientServerWindow = new Egg82LibEnhanced.Display.Window(1280, 720, "Client/Server Test", Styles.Titlebar | Styles.Close, true, 16);
			clientServerWindow.AddState(new ClientServerTestState());*/

			/*audioWindow = new Egg82LibEnhanced.Display.Window(1280, 720, "Audio Test", Styles.Titlebar | Styles.Close, true, 16);
			audioWindow.AddState(new AudioTestState());*/

			/*cryptoWindow = new Egg82LibEnhanced.Display.Window(1280, 720, "Crypto Test", Styles.Titlebar | Styles.Close, true, 16);
