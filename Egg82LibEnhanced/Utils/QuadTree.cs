...
namespace Egg82LibEnhanced.Utils {
	...
	internal class QuadTreeObject<T> where T : IQuad //, IComparable<QuadTreeObject<T>>
	{
		/// <summary>
	...
	public class QuadTree<T> : ICollection<T> where T : IQuad {
		...
		/// </summary>
		public PreciseRectangle QuadRect {
		...
		public List<T> GetObjects(PreciseRectangle rect) {
	...
	/// </summary>
	/// <typeparam name="T">Any object implementing IQuadStorable.</typeparam>
	public class QuadTreeNode<T> where T : IQuad {
		#region Constants
		...
		private PreciseRectangle rect; // The area this QuadTree represents
		...
		/// </summary>
		/// <param name="rect">The area this QuadTree object will encompass.</param>
		public QuadTreeNode(PreciseRectangle rect) {
			this.rect = rect;
		}
		...
		public QuadTreeNode(double x, double y, double width, double height) {
			rect = new PreciseRectangle(x, y, width, height);
		}
		...
		internal List<T> GetObjects(PreciseRectangle searchRect) {
